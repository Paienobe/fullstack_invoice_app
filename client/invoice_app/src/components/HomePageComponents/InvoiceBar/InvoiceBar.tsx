...
const InvoiceBar = ({ invoice }: InvoiceBarProps) => {
  return (
    <div className="h-[5.125rem] bg-white rounded-lg border-[1px] border-transparent hover:border-purple transition-colors duration-300 cursor-pointer py-4 px-6 grid grid-cols-custom items-center font-light gap-8">
      <div>
      ...
      <div className="font-bold text-text_dark text-right text-[1.125rem]">
        <p>£{invoice.total}</p>
      </div>
